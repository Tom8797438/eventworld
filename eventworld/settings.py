...
DEBUG = True
# DEBUG = True => css actif http://192.168.56.1:8000/admin/
# DEBUG = False => css non actif http://192.168.56.1:8000/admin/
...
MIDDLEWARE = [
    ...
    'EventWorldApp.utils.middleware.TemporaryScannerEventRestrictionMiddleware',
]
...
# Configuration pour gérer les fichiers médias
